...
**License**: <a href="LICENSE">License</a> | <a href="LICENSE_3rd.md">Third Party</a> <br>
...
<br>
&nbsp;&nbsp;QA Maker 시스템은 도메인 URL만으로 해당 도메인의 질의응답 시스템을 자동으로 생성하는 웹 프레임워크이다. QA Maker 시스템은 아래 그림과 같이 크게 QA 생성 서버 부분과 생성된 QA 시스템으로 구성된다. 
<br/>
